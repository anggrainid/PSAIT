...
<html lang="en">
    ...
    <body id="page-top">
        ...
        -->
        <!-- Projects-->
        <section class="projects-section bg-light" id="rekomendasi">
            <div class="container px-4 px-lg-5">
        ...
        <!-- Daftar Harga -->
        <section class="about-section text-center" id="daftar_harga" style="padding-top: 50px; padding-bottom: 50px;">
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                            include "koneksi.php";
                            $data = mysqli_query($mysqli, "SELECT * FROM daftar_harga");
                            $no = 1;
                            foreach ($data as $row){
