...
<html lang="en">
    ...
    <body id="page-top">
        ...
        curl_setopt($curl, CURLOPT_URL, 'http://192.168.0.99/psait/sait_project_api_enji/tempat_wisata_api.php?id='.$id.'');
        $res = curl_exec($curl);
        ...
        <section class="about-section" style="padding-top:150px; padding-bottom:150px; background: linear-gradient(to bottom, #000 0%, rgba(0, 0, 0, 0.9) 75%, rgba(0, 0, 0, 0.8) 100%);" id="about">
            <div class="container px-4 px-lg-5">
                ...
                <div class="col-lg-8 col-xl-6 text-center">
                    <h2 class="text-white">Memperbarui Data Tempat Wisata Hits!</h2>
                    <hr class="divider" />
                    <p class="text-white mb-5" style="margin-bottom: 5rem;">Yuk lengkapi form di bawah ini untuk memperbarui data tempat wisata hits!</p>
                </div>
            </div>
            <form method="post" action="updateWisataDo.php" class="text-white">
            <input type = "hidden" name="id" value="<?php echo"$id";?>">
            <div class="form-group row">
                <label for="nama_lengkap" class="col-sm-2 col-form-label">Tempat Wisata</label>
                <div class="col-sm-10">
                <input  type="text" name="tempat_wisata" class="form-control" id="tempat_wisata" value="<?php echo($json["data"][0]["tempat_wisata"]); ?>" required>
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="text" name="jam_buka" class="form-control" id="jam_buka" value="<?php echo($json["data"][0]["jam_buka"]); ?>" required>
                </div>
            </div>
            <br>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="text" name="harga" class="form-control" id="harga" value="<?php echo($json["data"][0]["harga"]); ?>" required>
                </div>
            </div>
            <br>
